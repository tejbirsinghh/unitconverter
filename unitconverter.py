...
root.config(bg = '#323133' )
labelfont = ('ariel', 56, 'bold')
l=Label(root,text='UNIT CONVERTER',bg="#323133" , fg="#FFFFFF",font = ("Arial", 24, "bold"))
l.place(x=80,y=20)

widget = Button(None, text="QUIT", bg="#426add", fg="#FFFFFF",font = ("Arial", 10, "bold"), relief = RAISED, bd=5, highlightbackground = "red", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=root.destroy).place(x=350,y=350)
...
def TemperatureConverter():
    ...
    celLabel = Label (top, text = "Celcius: ", font = ("Arial", 16), fg = "blue")
...
widget = Button(root, text="Temperature converter", bg="#375295" , fg="#FFFFFF",font = ("Arial", 14, "bold"), relief = RAISED, bd=3, justify = CENTER, highlightbackground = "#FFFFFF", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=TemperatureConverter,  padx = 4, pady =5).place(x=50,y=120)
widget = Button(root, text="Length Converter", bg="#375295" , fg="#FFFFFF",font = ("Arial", 14, "bold"), relief = RAISED, bd=3, justify = CENTER, highlightbackground = "#FFFFFF", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=LengthConverter, padx = 30, pady =5).place(x=50,y=180)
widget = Button(root, text="Area Converter", bg="#375295" , fg="#FFFFFF",font = ("Arial", 14, "bold"), relief = RAISED, bd=3, justify = CENTER, highlightbackground = "#FFFFFF", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=AreaConverter, padx = 41, pady =5).place(x=50,y=240)
widget = Button(root, text="Weight Converter", bg="#375295" , fg="#FFFFFF",font = ("Arial", 14, "bold"), relief = RAISED, bd=3, justify = CENTER, highlightbackground = "#FFFFFF", overrelief = GROOVE, activebackground = "green", activeforeground="blue", command=WeightConverter, padx = 31, pady =5).place(x=50,y=300)
